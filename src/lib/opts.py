...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='coco',
                                 help='coco | kitti | coco_hp | pascal | dota')
        ...
        self.parser.add_argument('--ot_gauss', action='store_true',
                                 help='a new gaussian for obb.')
        ...
        self.parser.add_argument('--a_weight', type=float, default=1.,
                                 help='loss weight for bounding box angle.')
        # multi_pose
